      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-4">
        <div>
          ...
          <ul>
            ...
            <li><Link href="/terms">Quy chế hoạt động</Link></li>
          </ul>
        </div>
        <div>
          <h3 className="font-bold">Hỗ trợ khách hàng</h3>
          <ul>
            <li><Link href="/order-status">Kiểm tra đơn hàng</Link></li>
            <li><Link href="/warranty">Tra cứu thông tin bảo hành</Link></li>
            <li><Link href="/guide">Hướng dẫn mua online</Link></li>
          </ul>
        </div>
        <div>
