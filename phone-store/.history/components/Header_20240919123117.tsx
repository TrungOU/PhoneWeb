...
export default function Header() {
  return (
    <header className="bg-cyan-500 p-4 fixed top-0 left-0 right-0 z-50">
      <div className="container mx-auto flex items-center justify-between bg-cyan-600 rounded-lg p-3">
